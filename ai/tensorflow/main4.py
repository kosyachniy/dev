...
classifier = tf.estimator.DNNClassifier(feature_columns=my_feature_columns, hidden_units=[128, 512], n_classes=2,
...
W_out = tf.Variable(tf.random_normal([len(xx[0]), 1]))
y_ = tf.matmul(x, W_out)
