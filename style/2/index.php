...
<hr>
<div class="list"><div>Проекты</div>
	<a href="https://t.me/cryptotraders100ru">Телеграмм бот "Дневник криптотрейдеров"</a>
...
Имитация поведения человека в социальной сети, постинг, лайки, репосты, анализ взаимности, анализ популярности, автонакрутка
	<a>Прогноз биржи Газпром</a>
	<a>Парсер синтаксиса</a>
	<a>Корпус слов</a>
	<a href="http://sourceme.ru/">Сайт Газеты</a>
	<a href="http://pr-light.ru/">Сайт Рекламного агентства</a>
Тонко подстраиваемый кабинет администратора
</div>
<hr>
<div class="list"><div>Достижения</div>
	<a>Первое место на региональном уровне Всероссийской Олимпиады Школьников</a>
	<a>Диплом III степени МФТИ</a>
