...
№ | Где | Ошибка | Решение
---|---|---|---
1 | ``` ai/tensorflow ``` | Попробовать обучать нейронные сети после нахождения весов мат алгоритмами | 
2 | ``` db ``` | Добавить работу с MySQL (Lite?) |
3 | ``` bot/twi ``` | Изменить активность бота, чтобы не блокировали |
