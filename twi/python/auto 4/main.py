...
arg=len(sys.argv)
s['default']['StartFollow']=sys.argv[5] if arg>=5 else 'PomidorWatsona'
s['default']['NotRussian']=False if arg>=4 and sys.argv[4]=='ru' else True
s['default']['Post']=False if arg>=3 and sys.argv[3]=='x' else True
...
#Автопостинг
if s['default']['Post']: threading.Thread(target=post, args=(me,)).start()
